...
def parse_option():
    ...
    parser.add_argument('--loao', nargs="+", type=float, default=None,
                        help='the rotation(s) to leave out of training')
    # positions
    parser.add_argument('--position', type=str, default= None, help='Test one of 5 positions(T, RA, LA, LL, RL)')
    ...
    opt.model_name = '{}_{}_{}_lr_{}_decay_{}_bsz_{}_temp_{}_lambda_{}_lodo_{}_trial_{}_seed_{}'.\
        format(opt.method, opt.dataset, opt.model, opt.learning_rate,
               opt.weight_decay, opt.batch_size, opt.temp, opt.lambda_factor, opt.LODO, opt.trial, opt.seed)
